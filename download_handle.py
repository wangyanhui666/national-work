...
class DownloaderHandle(object):
    ...
    def handle_gdp(self):
        ...
        for i in range(20):
            self.product1.append(self.text['returndata']['datanodes'][int(59-i)]['data']['data'])
        for i in range(20):
            self.product2.append(self.text['returndata']['datanodes'][int(79-i)]['data']['data'])
        for i in range(20):
            self.product3.append(self.text['returndata']['datanodes'][int(99-i)]['data']['data'])
    ...
    def handle_come(self):
        ...
        print(self.income, self.outcome)
